  ...
  "node_modules/strict-event-emitter/lib/Emitter.js"(exports) {
    ...
    var _Emitter = class {
      constructor() {
        ...
        __publicField(this, "hasWarnedAboutPotentialMemortyLeak");
      ...
      addListener(eventName, listener) {
        ...
        if (this.maxListeners > 0 && this.listenerCount(eventName) > this.maxListeners && !this.hasWarnedAboutPotentialMemortyLeak) {
    ...
    __publicField(Emitter, "defaultMaxListeners", 10);
